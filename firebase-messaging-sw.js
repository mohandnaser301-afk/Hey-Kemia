// =========================================================
// Firebase Messaging Service Worker (FCM Background)
// =========================================================
...
// معالجة الرسائل السحابية عندما يكون التطبيق أو المتصفح في الخلفية
messaging.onBackgroundMessage(function(payload) {
  const notificationTitle = payload.notification ? payload.notification.title : (payload.data ? payload.data.title : "منصة هي كيميا ! 🧪");
